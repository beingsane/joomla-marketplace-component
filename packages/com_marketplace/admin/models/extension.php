...
class MarketplaceModelExtension extends JModelLegacy
{
    ...
    public function getItem()
    {
        if (empty($this->item)) {
            ...
            $query->select('a.marketplace_extension_id, a.name, a.icon, a.thumbnail, a.tags, a.pathway, a.plan,a.author, a.description, a.gallery, a.version, a.reviews, a.rating, a.item_url, a.author_url, a.details_url');
