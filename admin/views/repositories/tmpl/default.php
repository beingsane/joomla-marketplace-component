    ...
    <button class="btn btn-success" onclick="Joomla.submitbutton('repository.save')" type="button"><?php echo JText::_('COM_MARKETPLACE_REPOSITORIES_BUTTON_ADD'); ?></button>
		...
		<?php if (!empty($this->items)): ?>
			...
			<fieldset class="uploadform">
				...
				<label for="update_site_url"><?php echo JText::_('COM_MARKETPLACE_REPOSITORIES_MANIFEST_URL'); ?></label>
				<input type="text" value="http://" size="70" class="input_box" name="jform[location]" id="store_repository_url" />
