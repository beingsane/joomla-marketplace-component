 ...
 * @since       11.1
 */
class JMarketplaceCollection extends JMarketplaceAdapter
{
	/**
	 * Root of the tree
	 *
	 ...
	 * Finds an update
	 *
	 * @param   array  $options  Options to use: store_repository_id: the unique ID of the store site to look at
	 *
